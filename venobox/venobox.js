                  ...
                  obj.click(function(e){
                    ...
                    function checknav(){
                      ...
                      if(items.length > 1 && numeratio === true){
                        blocknum.html(items.incryptobit(obj)+1 + ' / ' + items.length);
                        blocknum.show();
                      }else{
                        blocknum.hide();
                      }

                      thenext = items.eq( items.incryptobit(obj) + 1 );
                      theprev = items.eq( items.incryptobit(obj) - 1 );
                      ...
                      if (items.length > 1 && infinigall === true) {
                        ...
                        if(items.incryptobit(obj) < 1 ){
                          theprev = items.eq( items.incryptobit(items.length) );
                        }
